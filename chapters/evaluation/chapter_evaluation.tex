...
As described in \sref{cgframeoutline} the dimension of Viscosity tries to measure an environments resistance to change.
...
viscosity - difficult to change type signature of gems.

Straw test: around 2:50 in Gem Cutter.
